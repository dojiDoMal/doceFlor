<template>
    ...
    <v-img height="250px" v-bind="$attrs"/>
    </div>
</template>
    ...
    expanded (status) {
      this.$nextTick(() => {
        if (status) {
          ...
          if(screenWidth <= 375) this.cloned.childNodes[1].setAttribute('style', 'height: 60% !important')
          else if(screenWidth <= 425) this.cloned.childNodes[1].setAttribute('style', 'height: 55% !important')
          else if(screenWidth <= 768) this.cloned.childNodes[1].setAttribute('style', 'height: 80% !important')
          else this.cloned.childNodes[1].setAttribute('style', 'height: 90% !important')
